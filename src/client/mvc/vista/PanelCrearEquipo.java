...
public class PanelCrearEquipo extends JPanel implements ActionListener
{
    ...
    /**
     * El comando para el bot�n Crear
     */
    ...
    /**
     * Es una referencia al di�logo al que pertenece este panel
     */
    ...
    /**
     * Es el campo de texto para ingresar el pa�s del equipo
     */
    ...
    /**
     * Es el campo de texto para ingresar el director t�cnico del equipo
     */
    ...
    /**
     * Es el bot�n que sirve para agregar un nuevo equipo
     */
    ...
    public PanelCrearEquipo( DialogoCrearEquipo d )
    {
        ...
        etiquetaDirector = new JLabel( "Director T�cnico: " );
        gbc.gridx = 0;
        gbc.gridy = 1;
    ...
    /**
     * Da el valor del campo de texto con el pa�s del equipo
     * @return Se retorn� el nombre del pa�s ingresado por el usuario
     */
    ...
    /**
     * Da el valor del campo de texto con el director t�cnico del equipo
