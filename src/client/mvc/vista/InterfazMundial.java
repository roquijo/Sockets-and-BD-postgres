...
public class InterfazMundial extends JFrame
{
    ...
    public void dispose( )
    {
    	int respuesta1 = JOptionPane.showConfirmDialog( this,  "�Quiere guardar la informaci�n del mundial?", "Error", JOptionPane.YES_NO_OPTION );
    ...
    public static void main( String[] args )
    {
        ...
        try
        {
            mundial = new Mundial( "./data/Equipos.txt" );
        }
