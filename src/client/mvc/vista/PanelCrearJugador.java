...
public class PanelCrearJugador extends JPanel implements ActionListener
{
    ...
    /**
     * Es la etiqueta "Posici�n: "
     */
    private JLabel etiquetaPosicion;

    /**
     * Es el campo de texto para ingresar la posici�n en la que juega el jugador
     */
    ...
    /**
     * Es el bot�n que sirve para agregar un nuevo jugador
     */
    ...
    /**
     * Da el valor del campo de texto con la posici�n del jugador
     * @return Se retorn� la posici�n del jugador ingresado por el usuario
     */
