...
public class PanelJugadores extends JPanel implements ActionListener
{
    ...
    /**
     * Es la etiqueta con la posici�n del jugador
     */
    ...
    public PanelJugadores( InterfazMundial ventana )
    {
        ...
        etiquetaImagen.setPreferredSize( new Dimension( 300, 350 ) );
        ...
        // Posici�n
        etiquetaPosicion = new JLabel( "Posici�n: " );
    ...
    public void cambiarJugador( Jugador j )
    {
        ...
        etiquetaValorEdad.setText( Integer.toString( jugador.darEdad( ) ) + " a�os" );
    ...
    /**
     * Cambia el equipo para el cual se muestran los jugadores en el panel y actualiza la informaci�n mostrada
    ...
    /**
     * Ejecuta las acciones asociadas a los eventos. Actualiza la informaci�n del jugador en el panel de acuerdo al jugador seleccionado en el comboBox
